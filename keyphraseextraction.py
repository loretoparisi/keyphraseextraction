# -*- coding: utf-8 -*-
"""KeyphraseExtraction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DkMIXfpIfLO4lBGi6XphUE5SaDSLiN_w
...
candidates = [word for word,score in score_keyphrases_by_textrank(text)]
candidates = candidates[0:5]
candidate_features = extract_candidate_features(candidates, text, abstract, title)
candidate_features = sorted(candidate_features.items(), key=lambda item: item[1]['term_count'], reverse=True)
#print(json.dumps(candidate_features,indent=4))
